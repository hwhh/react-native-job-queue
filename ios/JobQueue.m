...
RCT_EXTERN_METHOD(updateJobExecutionTime:(NSDictionary *)job)
...
RCT_EXTERN_METHOD(getActiveJobs:(RCTPromiseResolveBlock)resolve reject:(RCTPromiseRejectBlock)reject)
